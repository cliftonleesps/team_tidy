...
source(str_c(getwd(),"/insert_esmi.R"))
```
...
parse_jobs <- function(url) {
  ...
  # output path
  json_path <- str_c(getwd(), "/job_jsons/", company_name, "_", job_title, ".json")
...
```{r mongo-db}
connection_string = 'mongodb+srv://dbUser:Q47Ev1vZU8oEUGxF@cluster0.yvrzo.mongodb.net/test?readPreference=primary&ssl=true'
