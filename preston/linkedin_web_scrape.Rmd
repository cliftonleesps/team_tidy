...
batches <- c(
  as_tibble(read.csv("all_skills_df_batch_1.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_2.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_3.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_4.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_5.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_6.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_7.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_8.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_9.csv"), header = TRUE),
  as_tibble(read.csv("all_skills_df_batch_10.csv"), header = TRUE)
)
...
insert_esmi_data(batches[1], db_connection)
